    ...
    try
    {
		...
		if (session) {
            ...
            boost::shared_ptr<cql::cql_query_t> use_system(
                new cql::cql_query_t("USE mykeyspace;", cql::CQL_CONSISTENCY_ONE));
            ...
            boost::shared_ptr<cql::cql_query_t> select(
                new cql::cql_query_t("SELECT * from users;", cql::CQL_CONSISTENCY_ONE));
...
/*
            ...
            boost::shared_ptr<cql::cql_query_t> unbound_select(
                new cql::cql_query_t("SELECT * FROM users WHERE keyspace_name=mykeyspace;", cql::CQL_CONSISTENCY_ONE));
